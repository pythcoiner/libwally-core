# phase-4.task-1: Split 635f74df "psbt: add taproot script-path field support and signing" into 3 parts

## Goal

Split 635f74df "psbt: add taproot script-path field support and signing" into 3 parts
