# phase-42.task-1: Keep/Amend bbd832ad "tests: add taproot miniscript and PSBT script-path test functions" tests: taproot miniscript

## Goal

Keep/Amend bbd832ad "tests: add taproot miniscript and PSBT script-path test functions" tests: taproot miniscript
