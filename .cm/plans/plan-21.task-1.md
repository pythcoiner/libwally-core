# phase-21.task-1: ms_witness + ms_satisfaction structs (with failure-reporting fields)

## Goal

ms_witness + ms_satisfaction structs (with failure-reporting fields)
...
## Files to read
- `/home/pyth/rust-miniscript/src/miniscript/satisfy/mod.rs`
