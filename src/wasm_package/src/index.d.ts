...
export function musig_aggnonce_parse(bytes: Buffer|Uint8Array): Ref_wally_musig_aggnonce;
...
export function musig_keyagg_cache_parse(bytes: Buffer|Uint8Array): Ref_wally_musig_keyagg_cache;
export function musig_keyagg_cache_serialize(cache: Ref_wally_musig_keyagg_cache): Buffer;
export function musig_nonce_agg(pubnonces: Buffer|Uint8Array, n_pubnonces: number): Ref_wally_musig_aggnonce;
export function musig_nonce_gen(session_secrand32: Buffer|Uint8Array, seckey: Buffer|Uint8Array, pubkey33: Buffer|Uint8Array, keyagg_cache: Ref_wally_musig_keyagg_cache, msg32: Buffer|Uint8Array, extra_input32: Buffer|Uint8Array): [secnonce_out: Ref_wally_musig_secnonce, pubnonce_out: Ref_wally_musig_pubnonce];
export function musig_nonce_gen_counter(counter: bigint, seckey: Buffer|Uint8Array, pubkey33: Buffer|Uint8Array, keyagg_cache: Ref_wally_musig_keyagg_cache, msg32: Buffer|Uint8Array, extra_input32: Buffer|Uint8Array): [secnonce_out: Ref_wally_musig_secnonce, pubnonce_out: Ref_wally_musig_pubnonce];
export function musig_nonce_process(aggnonce: Ref_wally_musig_aggnonce, msg32: Buffer|Uint8Array, cache: Ref_wally_musig_keyagg_cache, adaptor: Buffer|Uint8Array): Ref_wally_musig_session;
export function musig_partial_sig_agg(partial_sigs: Buffer|Uint8Array, n_sigs: number, session: Ref_wally_musig_session): Buffer;
export function musig_partial_sig_free(sig: Ref_wally_musig_partial_sig): void;
export function musig_partial_sig_parse(bytes: Buffer|Uint8Array): Ref_wally_musig_partial_sig;
export function musig_partial_sig_serialize(sig: Ref_wally_musig_partial_sig): Buffer;
export function musig_partial_sig_verify(sig: Ref_wally_musig_partial_sig, pubnonce: Ref_wally_musig_pubnonce, pubkey: Buffer|Uint8Array, cache: Ref_wally_musig_keyagg_cache, session: Ref_wally_musig_session): void;
export function musig_partial_sign(secnonce: Ref_wally_musig_secnonce, seckey: Buffer|Uint8Array, cache: Ref_wally_musig_keyagg_cache, session: Ref_wally_musig_session): Ref_wally_musig_partial_sig;
export function musig_pubkey_agg(pub_keys: Buffer|Uint8Array): [agg_pk_out: Buffer, cache_out: Ref_wally_musig_keyagg_cache];
export function musig_pubkey_ec_tweak_add(cache: Ref_wally_musig_keyagg_cache, tweak: Buffer|Uint8Array): Buffer;
export function musig_pubkey_get(cache: Ref_wally_musig_keyagg_cache): Buffer;
export function musig_pubkey_to_xpub(agg_pk: Buffer|Uint8Array, version: number): Ref_ext_key;
export function musig_pubkey_xonly_tweak_add(cache: Ref_wally_musig_keyagg_cache, tweak: Buffer|Uint8Array): Buffer;
export function musig_pubkeys_agg_then_derive(pub_keys: Buffer|Uint8Array, version: number, child_num: number): [pub_key_out: Buffer, child_out: Ref_ext_key];
export function musig_pubkeys_derive_then_agg(xpubs: Buffer|Uint8Array, child_num: number): [agg_pk_out: Buffer, cache_out: Ref_wally_musig_keyagg_cache];
export function musig_pubnonce_free(nonce: Ref_wally_musig_pubnonce): void;
export function musig_pubnonce_parse(bytes: Buffer|Uint8Array): Ref_wally_musig_pubnonce;
...
export function musig_session_parse(bytes: Buffer|Uint8Array): Ref_wally_musig_session;
...
export function psbt_input_add_musig2_partial_sig(input: Ref_wally_psbt_input, participant: Buffer|Uint8Array, agg_pubkey: Buffer|Uint8Array, leaf_hash: Buffer|Uint8Array, partial_sig: Buffer|Uint8Array): void;
export function psbt_input_add_musig2_participant_pubkeys(input: Ref_wally_psbt_input, agg_pubkey: Buffer|Uint8Array, participants: Buffer|Uint8Array): void;
export function psbt_input_add_musig2_pubnonce(input: Ref_wally_psbt_input, participant: Buffer|Uint8Array, agg_pubkey: Buffer|Uint8Array, leaf_hash: Buffer|Uint8Array, pubnonce: Buffer|Uint8Array): void;
...
export function psbt_input_find_musig2_partial_sig(input: Ref_wally_psbt_input, participant: Buffer|Uint8Array, agg_pubkey: Buffer|Uint8Array, leaf_hash: Buffer|Uint8Array): number;
export function psbt_input_find_musig2_pubkey(input: Ref_wally_psbt_input, agg_pubkey: Buffer|Uint8Array): number;
export function psbt_input_find_musig2_pubnonce(input: Ref_wally_psbt_input, participant: Buffer|Uint8Array, agg_pubkey: Buffer|Uint8Array, leaf_hash: Buffer|Uint8Array): number;
...
export function psbt_input_get_musig2_partial_sig_count(input: Ref_wally_psbt_input): number;
export function psbt_input_get_musig2_pubnonce_count(input: Ref_wally_psbt_input): number;
...
export function psbt_musig2_add_nonce(psbt: Ref_wally_psbt, index: number, session_secrand32: Buffer|Uint8Array, seckey: Buffer|Uint8Array, pubkey33: Buffer|Uint8Array, agg_pubkey: Buffer|Uint8Array, leaf_hash: Buffer|Uint8Array, keyagg_cache: Ref_wally_musig_keyagg_cache, flags: number): Ref_wally_musig_secnonce;
export function psbt_musig2_finalize_input(psbt: Ref_wally_psbt, index: number, agg_pubkey: Buffer|Uint8Array, leaf_hash: Buffer|Uint8Array, keyagg_cache: Ref_wally_musig_keyagg_cache, flags: number): void;
export function psbt_musig2_sign(psbt: Ref_wally_psbt, index: number, secnonce: Ref_wally_musig_secnonce, seckey: Buffer|Uint8Array, pubkey33: Buffer|Uint8Array, agg_pubkey: Buffer|Uint8Array, leaf_hash: Buffer|Uint8Array, keyagg_cache: Ref_wally_musig_keyagg_cache, flags: number): Ref_wally_musig_partial_sig;
export function psbt_output_add_musig2_participant_pubkeys(output: Ref_wally_psbt_output, agg_pubkey: Buffer|Uint8Array, participants: Buffer|Uint8Array): void;
...
export function psbt_output_find_musig2_pubkey(output: Ref_wally_psbt_output, agg_pubkey: Buffer|Uint8Array): number;
